        ...
        <div id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                <div class="home-message">
                    ...
                    <p> AGREGAR EDITORIALES</p>
                    
                    <div class="row">
            <div class="col-lg-12">
                  <a href="nuevaEditorial.php" class="btn btn-default pull-right">Nueva Editorial</a>
</br>
              <div class="widget">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tbody>
                        ...
                        <td>Salamandra</td>
                        <td>
                        <a href="./index.php?view=editeditorial&amp;id=1" class="btn btn-warning btn-xs">Editar</a>
                        <a href="./index.php?action=deleditorial&amp;id=1" class="btn btn-danger btn-xs">Eliminar</a>
                        </td>
                        </tr>
                                            </tbody>
                    </table>
