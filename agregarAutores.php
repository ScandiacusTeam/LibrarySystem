        ...
        <div id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                <div class="home-message">
                    ...
                    <div class="row">
            <div class="col-lg-12">
                  <a href="nuevoAutor.php" class="btn btn-default pull-right">Nuevo Autor</a>
</br>
              <div class="widget">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tbody>
                        ...
                        <td>Rowling</td>
                        <td>
                        <a href="./index.php?view=editautor&amp;id=1" class="btn btn-warning btn-xs">Editar</a>
                        <a href="./index.php?action=delautor&amp;id=1" class="btn btn-danger btn-xs">Eliminar</a>
                        </td>
                        </tr>
                                            </tbody>
                    </table>
