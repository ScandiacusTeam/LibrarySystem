    ...
    <div id="wrapper">
        ...
        <div id="home" class="video-section js-height-full">
            ...
            <div class="col-lg-12">
                ...
                <form class="form-horizontal ng-pristine ng-valid" role="form" method="post" action="./index.php?action=addlibro">
                ...
                <div class="form-group">
                    <label for="inputEmail1" class="col-lg-2 control-label">año/Num. Pag</label>
                    <div class="col-lg-5">
                    <input type="text" name="anio" class="form-control" id="inputEmail1" required="" placeholder="Año">
                    </div>
                    <div class="col-lg-5">
