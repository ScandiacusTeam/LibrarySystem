            ...
            <nav class="navbar navbar-inverse">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.php"><img src="images/logo-normal.png" alt=""></a>
                    </div>
            ...
            <div class="vertical-header-wrapper">
                <nav class="nav-menu">
                    ...
                    <ul class="primary-menu">
                        <li class="child-menu"><a href="index.php">Inicio <i class="fa fa-angle-right"></i></a>
                            
                        </li>
                        <li class="child-menu"><a href="prestamos.php">Prestamos <i class="fa fa-angle-right"></i></a>
                           
                        </li>
                        <li class="child-menu"><a href="libros.php">Libros <i class="fa fa-angle-right"></i></a>
                           
                        </li>
                        <li class="child-menu"><a href="#">agregar <i class="fa fa-angle-right"></i></a>
                            <div class="sub-menu-wrapper">
                                    <ul class="sub-menu center-content">
                                        <li><a href="agregarLibros.php">Libros</a></li>
                                        <li><a href="agregarAutores.php">Autores</a></li>
                                        <li><a href="agregarEditorial.php">Editoriales</a></li>
                                        <li><a href="agregarCategoria.php">Categorias</a></li>
                                        <li><a href="agregarUsuarios.php">Usuarios</a></li>
                                        <li><a href="agregarAdministradores.php">Administradoes</a></li>
                                    </ul>
                                </div>
                        </li>
                        <li class="child-menu"><a href="informes.php">Informes <i class="fa fa-angle-right"></i></a>
    ...
    <div id="wrapper">
        ...
        <div id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                ...
                <div class="col-lg-12">
                  <a href="agregarLibros.php" class="btn btn-default pull-right">Nuevo Libro</a>
                </br>
              <div class="widget">
                ...
                <div class="widget-body no-padding">
                  ...
                  <div class="table-responsive">
                    <table class="table datatable dataTable" id="DataTables_Table_0">
                    <thead>
                      <tr><th>ISBN</th>
                      <th>Titulo</th>
                      </tr></thead>
                      ...
                      <tbody>
                        <tr>
                        <td>978-84-9838-141-2</td>
                        <td>Harry Potter</td>
                        <td>
                        <a href="ejemplares.php" class="btn btn-default btn-xs">Ejemplares</a>
                        <a href="agregarEjemplares.php" class="btn btn-success btn-xs">Agregar Ejemplar</a>
                    ...
                    <div class="col-lg-9 col-md-9 text-right">
                        <div class="cop-links">
                            <ul class="list-inline">
                                <li>&copy; 2019 Genius | Design: <a href="https://html.design">HTML Design</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
