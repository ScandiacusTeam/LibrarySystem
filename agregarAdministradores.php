        ...
        <div id="home" class="video-section js-height-full">
            ...
            <div class="home-text-wrapper relative container">
                <div class="home-message">
                    ...
                    <div class="row">
            <div class="col-lg-12">
                  <a href="nuevoAdministrador.php" class="btn btn-default pull-right">Nuevo Administrador</a>
</br>
              <div class="widget">
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      <tbody>
                        ...
                        <td>Delgado</td>
                        <td>
                        <a href="./index.php?view=editadmin&amp;id=1" class="btn btn-warning btn-xs">Editar</a>
                        <a href="./index.php?action=deladmin&amp;id=1" class="btn btn-danger btn-xs">Eliminar</a>
                        </td>
                        </tr>
                                            </tbody>
                    </table>
